...
class ArticleGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("checkoutapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Article entity")
        ...
        .formParam("client_id", "checkoutapp")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "coreId":null, "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "price":null, "deliveryCosts":null, "currency":null, "image1":null, "image2":null}""")).asJSON
            .check(status.is(201))
