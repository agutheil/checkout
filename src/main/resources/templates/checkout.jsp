<%@page import="com.mightymerce.checkout.PayPal"%>
...
<%@ include file="header.jsp" %>
 ...
 paypal.checkout.setup('<%= new com.mightymerce.checkout.PayPal().getGvAPIUserName() %>', {
 button: 'placeOrderBtn',
 environment: '<%= new com.mightymerce.checkout.PayPal().getEnvironment() %>',
 condition: function () {
